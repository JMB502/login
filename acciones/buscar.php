     ...
     <div>
        ...
        <table border = "2" >
           ...
           $conexion = mysqli_connect($host,$user, $pass, $db);
            ...
            $sql = "SELECT id,modelo,marca,imei FROM celulares where modelo like '$buscar' '%' or marca like '$buscar' '%' or imei like '$buscar' '%'  order by id desc";
            ...
            while ($mostrar = mysqli_fetch_row($rta)) {
                ...
                <tr>
                    ...
                    imei= <?php echo $mostrar ['3'] ?> 
                        ...
                        ">EDITAR</a>
                        <a href="sp_eliminar.php?  id= <?php echo $mostrar ['0'] ?>
                        ">ELIMINAR</a>
